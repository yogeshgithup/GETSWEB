...
<!--                      <li><a href="ManageCourseFees.jsp">Manage Course</a></li>-->
                  ...
                  <li><a href="UploadMaterial.jsp"><i class="fa fa-edit"></i> Upload Material </a></li>
                  <li><a href="ViewListOfStudents.jsp"><i class="fa fa-table"></i> View List of Students </a></li>
                  <li><a href="VerifyUsers.jsp"><i class="fa fa-bug"></i> Verify Users </a></li>
