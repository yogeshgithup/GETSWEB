...
<%session.removeAttribute("msg");%>
                   ...
                   <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<%=application.getContextPath()%>/SerBreakTime?wsid=<%=session.getAttribute("wsid")%>">
